...
namespace LearnLanguages.Business
{
  ...
  public class LanguageEdit : Bases.BusinessBase<LanguageEdit, LanguageDto>, IHaveId
  {
    ...
    private ILanguageDalAsync _LanguageDalAsync;

    public ILanguageDalAsync LanguageDalAsync
    {
      get
      {
        if (_LanguageDalAsync == null)
        {
          _LanguageDalAsync = Services.Container.GetExportedValue<ILanguageDalAsync>();
          if (_LanguageDalAsync == null)
