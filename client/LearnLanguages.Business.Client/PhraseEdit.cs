...
namespace LearnLanguages.Business
{
  ...
  public class PhraseEdit : LearnLanguages.Business.Bases.BusinessBase<PhraseEdit, PhraseDto>, IHaveId
  {
    ...
    /// <returns></returns>
    public static PhraseEdit NewPhraseEdit(PhraseDto dto)
    {
      PhraseEdit retPhrase = new PhraseEdit();
    ...
    private IPhraseDalAsync _PhraseDal;

    public IPhraseDalAsync PhraseDal
    {
      get
      {
        if (_PhraseDal == null)
        {
          _PhraseDal = Services.Container.GetExportedValue<IPhraseDalAsync>();
          if (_PhraseDal == null)
